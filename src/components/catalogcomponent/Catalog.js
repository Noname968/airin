                ...
                <div className={styles.searchmobil}>
                    <div className={styles.search}>
                        ...
                        <Input
                            ...
                            isClearable
                            autoComplete="off"
                            startContent={<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-2xl text-default-400 pointer-events-none flex-shrink-0">
                    ...
                    <button className='flex lg:hidden items-end cursor-default' onClick={resetValues} disabled={isFormEmpty}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mb-2 cursor-pointer">
                        ...
                        <Accordion isCompact variant="splitted" defaultExpandedKeys={["2"]} >
                            <AccordionItem key="2" aria-label="Accordion 1" title="Season">
                                <>
                                    ...
                                    >
                                        {seasonOptions.map((season) => (
                                            <Radio value={season.value}>{season.name}</Radio>
                                        ))}
                                    </RadioGroup>
                                </>
                            </AccordionItem>
                    ...
                    <div className={styles.accordion}>
                        <Accordion isCompact variant="splitted" defaultExpandedKeys={["3"]}>
                            <AccordionItem key="3" aria-label="Accordion 1" title="Format">
                                ...
                                >
                                    {formatOptions.map((format) => (
                                        <Radio value={format.value}>{format.name}</Radio>
                                    ))}
                                </RadioGroup>
                            </AccordionItem>
                        </Accordion>
